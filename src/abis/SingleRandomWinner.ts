export default [
  ...
  {
    inputs: [
      { internalType: "address", name: "_externalErc20", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_externalErc721", type: "address" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_prizePeriodStart", type: "uint256" },
      { internalType: "uint256", name: "_prizePeriodSeconds", type: "uint256" },
      {
      ...
      { internalType: "address", name: "_sponsorship", type: "address" },
      { internalType: "contract RNGInterface", name: "_rng", type: "address" },
      { internalType: "address[]", name: "_externalErc20s", type: "address[]" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "_externalErc20", type: "address" },
      { internalType: "address", name: "_prevExternalErc20", type: "address" },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "_externalErc721", type: "address" },
      { internalType: "address", name: "_prevExternalErc721", type: "address" },
    ],
  ...
  },
  {
    ...
    name: "rng",
    outputs: [
      { internalType: "contract RNGInterface", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint32", name: "_rngRequestTimeout", type: "uint32" },
    ],
